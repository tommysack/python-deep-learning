...
model.add(keras.layers.GRU(64)) #Analyze the sequences of words and capture dependencies between them
...
print("\n------SUMMARY------")
model.summary() #Trainable params: 522,337
...
print("\n------TESTING------")
model.evaluate( # loss: 0.4359 - accuracy: 0.8668
  X_test,
  Y_test,
  batch_size=10
)
