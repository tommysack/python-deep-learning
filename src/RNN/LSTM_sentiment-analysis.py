...
model.add(keras.layers.LSTM(64)) #Analyze the sequences of words and capture dependencies between them
...
print("\n------SUMMARY------")
model.summary() #Trainable params: 529,505
...
print("\n------TESTING------")
model.evaluate( # loss: 0.4348 - accuracy: 0.8514
  X_test,
  Y_test,
  batch_size=10
)
